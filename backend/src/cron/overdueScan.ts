...
import { prisma, withoutTenant, withTenant } from '../utils/prisma';
 ...
 * Persists in-app notifications directly to PostgreSQL, iterating per organization.
 */
...
/**
 * Scans employees who have not checked in on working days by 10:00 AM, iterating per organization.
 */
